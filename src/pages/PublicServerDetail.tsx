...
export default function PublicServerDetail() {
  ...
  return (
    <main className="mx-auto w-full max-w-[90rem] flex-1 px-4 py-8 sm:px-6 md:px-8 md:py-12">
      ...
      <section className="mt-8 rounded-[28px] border border-white/10 bg-white/[0.035] p-4 sm:p-6" aria-labelledby="study-board-heading">
